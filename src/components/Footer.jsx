      ...
      <div className="max-w-full md:max-w-3xl lg:max-w-5xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="text-justify">
          ...
          <p>
            ...
            unde hic eum illum corporis, ipsum in nesciunt. Commodi at vel rem.
          </p>
        ...
        <div className="md:max-w-full md:mx-auto text-justify">
          <h1 className="font-bold text-xl tracking-wide mb-4">Links</h1>
        ...
        <div className="text-justify">
          <h1 className="font-bold text-xl tracking-wide mb-4">Reach Us</h1>
